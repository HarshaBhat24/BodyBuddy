        ...
        while True:
            ...
            try:
                ...
                if eang1 > 170:
                    ...
                    plankTimer = time.time()
                    Accuracy = (plankDuration/elapsedTime)*100
                else:
                    plankTimer = None
            ...
            if cv2.waitKey(5) & 0xFF == 27:
                print(f'Plank duration - {round(plankDuration)} seconds')
                print(f'Plank Accuracy - {round(Accuracy,2)} %')
                if Accuracy >= 80:
                    print('Plank Exercise Successful')
                else:
                    print('''Your posture is a little incorrect , try to keep your body straight''')
                break
            if threaded_camera.total_frames<=0:
                if Accuracy >= 80:
                    print(f'''Plank Exercise Successful
                           Total duration = {round(plankDuration)} seconds
